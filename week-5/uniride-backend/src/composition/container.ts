...
export const VERSION = "0.5.0-week5";

export interface Container {
  app: Express; logger: Logger; config: AppConfig;
  booking: RideBookingFacade; geocoder: GeocodingPort; driverRepo: DriverRepository; analytics: AnalyticsObserver;
}
...
export function buildContainer(env: NodeJS.ProcessEnv = process.env): Container {
  ...
  // W5 Observer: ride events fan out to notifier + analytics.
  ...
  return { app, logger, config, booking, geocoder, driverRepo, analytics };
}
